...
.constant('URL', {
	...
	'getAdeherenceData':'api/user/USERID/adherenceTrend?from=FROM_DATE&to=TO_DATE&page=PAGE&per_page=PER_PAGE', 
	...
	'getThreaddata':'api/messagesReceivedThreads/ID/ROOTID'
});