...
angular.module('hillromvestApp')
  .controller('LoginController',['$scope','$state','deviceDetector', '$timeout', 'Auth', 'vcRecaptchaService', 'globalConfig', '$rootScope', 'loginConstants', 'Principal', 'StorageService', 'patientsurveyService',
	...
	$scope.chechBrowserCompatibility = function() {
      ...
      if ((deviceDetector.browser == 'chrome' && deviceDetector.browser_version >='38' ) || (deviceDetector.browser == 'ie' && deviceDetector.browser_version >= 11 ) || (deviceDetector.browser == 'firefox' && deviceDetector.browser_version >= '38' )  || (deviceDetector.browser == 'safari' && deviceDetector.browser_version >= '7' )) {
