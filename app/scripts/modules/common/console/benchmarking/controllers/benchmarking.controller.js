		    ...
		    plotOptions: {
		      ...
		      false],
					formatter: function() {
						...
						var s = '<div style="font-size:12px ;padding-bottom: 3px;font-weight:bold;margin-bottom:4px">'+ date + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div><div style="font-size:10px; padding-bottom: 3px;">'+ xAxis + ' : ' + this.x +'</div><div>';
			    	$.each(this.points, function(i, point) {
			      	s += '<div style="font-size:10px; width:100%;"><div style="color:'+ point.series +';padding:0;width:auto;float:left"> ' + point.series.name + ' : </div> ' 
